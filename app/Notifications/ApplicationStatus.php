...
class ApplicationStatus extends Notification
{
    ...
    protected function acceptedMail()
    {
        return (new MailMessage)
            ...
            ->line('You are scheduled for a Credit Investigation interview with our CI representative as follows:')
            ->line('**Date:** ' . $this->statusData['schedule'])
            ->line('**Time:** 9:00 AM')
            ->line('**Location:** Jain bldg. Sto. Nino Panabo City, Davao del Norte')
